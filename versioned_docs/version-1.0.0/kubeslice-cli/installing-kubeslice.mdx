...
[topology configuration](/versioned_docs/version-1.0.0/reference/sample-configuration-file.mdx) file.
...
[demo using cloud clusters](/versioned_docs/version-1.0.0/tutorials/kubeslice-cli-demo-on-cloud-clusters.mdx).
...
register the new worker cluster with the KubeSlice Controller. For more information, see [demo using cloud clusters](/versioned_docs/version-1.0.0/tutorials/kubeslice-cli-demo-on-cloud-clusters.mdx).
