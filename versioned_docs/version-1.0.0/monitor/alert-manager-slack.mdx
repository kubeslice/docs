...
6. Under **Post to Channel**, choose **kubeslice-events-alerts** to post the alerts. 
...
8. You get a webhook URL that you should copy and note it down in a separate file for using it later. 

   ![alt](/images/version1.0.0/monitor/slack-copy-webhook-url.png)

9. Click **Save Settings** to save the webhook integration. 

   ![alt](/images/version1.0.0/monitor/slack-webhook-save.png)
   
10. Go back to the KubeSlice Controller command terminal. You must have a `monitoring` namespace when you had installed KubeSlice. If it does not exist, 
...
11. Use the following command to complete the integration: 
