...
The Worker Operator (also known as Slice Operator) generates events that represent an operation 
on the worker cluster. All of these generated events are specific to KubeSlice operations. 

The Worker Operator logs the events in the `kubeslice-system` namespace. 
Use the following command to get the Worker Operator events:
...
These events are related to [service export](../getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces/#serviceexports)
of a worker cluster.
...
These events are related to [service import](../getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces/#serviceimports)
of a worker cluster.
...
| Sl. No | Event                       | Type    | Description                                                                                                                       |
| ------ | --------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 1      | NetPolAdded                 | WARNING | The slice network policy is added.                                                                                                |
