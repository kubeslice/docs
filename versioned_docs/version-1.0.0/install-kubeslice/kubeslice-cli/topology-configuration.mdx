...
| [image_pull_secret](#image-pull-secret-configuration-parameters)          | Object         | The image pull secrets to pull the Kubernetes dashboard image. Required for Enterprise charts only. | Mandatory |
...
configuration:
  ...
  helm_chart_configuration:
    ...
    # The ui_chart, prometheus_chart, and image_pull_secret parameters are required for `enterprise-demo` option (enterprise chart) only.
    ui_chart:
