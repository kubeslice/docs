...
charts using the following command:
   ...
   **Expected Output**
   ...
   kubeslice/kubeslice-controller  1.0.0           1.0.0           A Helm chart for kubeslice-controller
   kubeslice/kubeslice-worker      1.0.0           1.0.0           A Helm chart for kubeslice-worker
