...
see [Preparing the clusters for registration](/versioned_docs/version-1.0.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx).
...
:::info
For example YAML files on kind clusters, see [kind YAML examples](/versioned_docs/version-1.0.0/tutorials/kind-worker-cluster-registration.mdx).
:::
...
see [Cluster Registration Configuration Parameters](/versioned_docs/version-1.0.0/reference/configuration-parameters.mdx#cluster-registration-configuration-parameters)
:::
``` 
...
See [Script to get the secrets of the worker cluster](/versioned_docs/version-1.0.0/reference/script-to-get-the-secrets-of-the-worker-cluster.mdx).
:::
...
:::info
For example YAML files on kind clusters, see [kind YAML examples](/versioned_docs/version-1.0.0/tutorials/kind-worker-cluster-registration.mdx#create-the-slice-operator-yaml-file).
:::
...
:::info
To understand more about the configuration parameters, 
see [Slice Operator ConfigurationParameters](/versioned_docs/version-1.0.0/reference/configuration-parameters.mdx#slice-operator-configuration-parameters)
:::
