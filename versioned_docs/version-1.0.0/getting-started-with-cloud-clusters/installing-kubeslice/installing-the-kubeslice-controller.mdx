...
see [Adding the Helm Repository](/versioned_docs/version-1.0.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx#add-the-helm-repository).
...
:::info
For example YAML files on kind clusters, see [kind YAML examples](/versioned_docs/version-1.0.0/tutorials/kind-install-kubeslice-controller.mdx).
:::
...
[Controller Configuration Parameters](/versioned_docs/version-1.0.0/reference/configuration-parameters.mdx#controller-configuration-parameters)
:::
...
For more information, see [The KubeSlice Architecture](/versioned_docs/version-1.0.0/architecture.mdx).
...
:::info
For example YAML files on kind clusters, see [kind YAML examples](/versioned_docs/version-1.0.0/tutorials/kind-install-kubeslice-controller.mdx#create-a-project-yaml-file).
:::

:::info 
To understand more about the configuration parameters, 
see [Project Namespace Configuration Parameters](/versioned_docs/version-1.0.0/reference/configuration-parameters.mdx#project-namespace-configuration-parameters).
:::
