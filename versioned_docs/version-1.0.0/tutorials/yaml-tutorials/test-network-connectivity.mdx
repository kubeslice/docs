...
more, see [deploying the iPerf application on an intra-cluster slice](/versioned_docs/version-1.0.0/tutorials/yaml-tutorials/deploying-the-iperf-application-on-an-intra-cluster-slice.mdx).
:::
