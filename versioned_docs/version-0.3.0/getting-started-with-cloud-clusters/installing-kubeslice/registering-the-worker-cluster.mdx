...
see [Preparing the clusters for registration](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx).
...
see [Cluster Registration ConfigurationParameters](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters.mdx#cluster-registration-configuration-parameters)
:::
``` 
...
See [Script to get the secrets of the Workercluster](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/script-to-get-the-secrets-of-the-worker-cluster.mdx).
:::
...
:::info
To understand more about the configuration parameters, 
see [Slice Operator ConfigurationParameters](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters.mdx#slice-operator-configuration-parameters)
:::
