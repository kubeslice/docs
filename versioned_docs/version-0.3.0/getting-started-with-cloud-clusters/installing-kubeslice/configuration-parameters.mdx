...
| [standardQosProfileName](#slice-qos-profile-parameters) | String | This [name](#slice-qos-profile-metadata-parameter) of the [external QoS profile](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/creating-a-slice.mdx#creating-a-qos-profile) that you can apply for multiple slices. Note that `qosProfileDetails` and `standardQosProfileName` are mutually exclusive parameters. | Mandatory |
...
|Parameter|Parameter Type|Description|Required|
|----|----|----|----|
| [applicationNamespaces](#application-namespaces-parameters) | Array object | Defines the [namespaces that will be onboarded](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx) to the slice and their corresponding worker clusters. | Mandatory |
...
## Slice QOS Profile Parameters
These parameters are related to the QoS profile for the slice inter-cluster traffic 
configured in the [slice QoS profile configuration YAML file](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/creating-a-slice.mdx#creating-a-qos-profile). 
...
| [metadata](#slice-qos-profile-metadata-parameters) | Object | The metadata describes parameters (names and types) and attributes that have been applied. | Mandatory |
| [spec](#slice-qos-profile-specification-parameters) | Object | The specification of the desired state of an object. | Mandatory |

### Slice QoS Profile Metadata Parameter
|Parameter|Parameter Type|Description|Required|
|----|----|----|----|
| name | String | It is the name of the QoS profile. | Mandatory 

### Slice QoS Profile Specification Parameters
