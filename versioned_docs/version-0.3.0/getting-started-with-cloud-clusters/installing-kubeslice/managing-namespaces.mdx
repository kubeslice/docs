...
To on-board namespaces, you must add them as part of applicationNamespaces in the [slice configuration](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/installing-kubeslice/creating-a-slice.mdx#creating-the-slice-yaml-file) YAML file.
...
from accessing them. To know more, see [off-boarding namespaces](/versioned_docs/version-0.3.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/off-boarding-namespaces.mdx).
