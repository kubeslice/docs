...
* The issue where the exponential increase of goroutines in the gateway sidecar that caused
  CPU utilization is fixed. The fix reduces the CPU utilization by around 500 percent. 
