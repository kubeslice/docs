...
* The issue where an exponential increase of goroutines in the Gateway Sidecar component 
  caused abrupt CPU utilization is fixed. The fix reduces the CPU utilization by 
  around 500 percent. 
