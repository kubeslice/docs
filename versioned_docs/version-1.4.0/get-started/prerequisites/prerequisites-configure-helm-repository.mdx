...
charts using the following command:
   ...
   **Expected Output**
   ...
   kubeslice/kubeslice-controller  1.3.1           1.3.1           A Helm chart for kubeslice-controller
   kubeslice/kubeslice-worker      1.3.1           1.3.1           A Helm chart for kubeslice-worker
