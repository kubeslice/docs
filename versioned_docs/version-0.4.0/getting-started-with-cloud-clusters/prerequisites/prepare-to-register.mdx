...
:::info
After preparing the kind clusters, [add the helm repository](/versioned_docs/version-0.4.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx#add-the-helm-repository). 
:::
