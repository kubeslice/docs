...
see [Adding the Helm Repository](/versioned_docs/version-0.4.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx#adding-the-helm-repository).
