...
free to join our [community](/versioned_docs/version-0.4.0/community.mdx).
...
```
helm search repo kubeslice-oss
```
...
kubeslice-oss/cert-manager            v1.7.0           v1.7.0         A Helm chart for cert-manager                     
kubeslice-oss/istio-base              1.13.3           1.13.3         Helm chart for deploying Istio cluster resource...
kubeslice-oss/istio-discovery         1.13.3           1.13.3         Helm chart for istio control plane                
kubeslice-oss/kubeslice-controller    0.4.0            0.5.5          A Helm chart for kubeslice-controller             
kubeslice-oss/kubeslice-worker        0.4.0            0.11.0         KubeSlice Operator 
```
...
Configuration Parameters](/versioned_docs/version-0.4.0/reference/configuration-parameters.mdx#controller-configuration-parameters).
:::
...
Namespace Configuration Parameters](/versioned_docs/version-0.4.0/reference/configuration-parameters.mdx#project-namespace-configuration-parameters).
:::
...
[Script to Get the Secrets of the Worker Cluster](/versioned_docs/version-0.4.0/reference/script-to-get-the-secrets-of-the-worker-cluster.mdx).
:::
...
[scripts](/versioned_docs/version-0.4.0/reference/script-to-get-the-secrets-of-the-worker-cluster.mdx).
:::
...
feature. To know more, see [isolating namespaces](/versioned_docs/version-0.4.0/getting-started-with-cloud-clusters/installing-kubeslice/isolating-namespaces.mdx).
...
2. Onboard the existing `iperf` namespace to the slice. To know more, see
   [onboarding namespaces](/versioned_docs/version-0.4.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx).
...
Refer to [Uninstalling KubeSlice](/versioned_docs/version-0.4.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/uninstalling-kubeslice.mdx).
