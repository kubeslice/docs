...
The opensource KubeSlice repo charts URL is https://kubeslice.github.io/charts/.

Create the topology YAML file using the following template:
:::info
For more information on toplogy configuration parameters, see [kubeslice-cli Configuration Parameters](/versioned_docs/version-0.4.0/reference/kubeslice-cli-configuration-parameters.mdx)
:::
...
configuration:
  ...
  helm_chart_configuration:
    ...
    repo_url: https://kubeslice.github.io/charts/
    cert_manager_chart:
