...
see [Installing KubeSlice](/versioned_docs/version-1.2.0/install-kubeslice/yaml/yaml-controller-install.mdx) 
and [Registering the Worker Cluster](/versioned_docs/version-1.2.0/install-kubeslice/yaml/yaml-register-worker-clusters.mdx).
...
see [Creating a Slice](/versioned_docs/version-1.2.0/install-kubeslice/yaml/slice-operations/slice-operations-slice-creation.mdx).
...
in [offboarding namespaces](/versioned_docs/version-1.2.0/uninstall-kubeslice/uninstall-kubeslice.mdx#offboard-application-namespaces).
