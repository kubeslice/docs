...
For more information, see the [slice configuration](/versioned_docs/version-1.2.0/install-kubeslice/yaml/slice-operations/slice-operations-slice-creation.mdx#slice-creation).