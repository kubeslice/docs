...
- Istio version 1.13 is incompatible with Kubernetes version 1.24. It might cause issues with KubeSlice version 0.5.0, which 
  ...
  * [Prerequisites](/versioned_docs/version-1.2.0/get-started/prerequisites/prerequisites-install-istio.mdx)
  * [Register the worker cluster](versioned_docs/version-1.2.0/install-kubeslice/yaml/yaml-register-worker-clusters.mdx)
  * [Create a slice](/versioned_docs/version-1.2.0/install-kubeslice/yaml/slice-operations/slice-operations-slice-creation.mdx)
  * [Deploy the BookInfo application](/versioned_docs/version-1.2.0/tutorials/yaml-tutorials/deploy-the-bookinfo-application.mdx)