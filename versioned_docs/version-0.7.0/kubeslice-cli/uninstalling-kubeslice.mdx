...
[offboard Namespaces](/versioned_docs/version-0.7.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/offboarding-namespaces.mdx).
...
the Slice Operator, follow the instructions in the [uninstall the Slice Operator](/versioned_docs/version-0.7.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/deregistering-the-worker-cluster.mdx#uninstall-the-slice-operator) 
section.
...
[uninstall the KubeSlice Controller](/versioned_docs/version-0.7.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/uninstalling-the-kubeslice-controller.mdx).
