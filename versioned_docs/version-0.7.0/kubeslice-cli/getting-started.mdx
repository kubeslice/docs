...
Example
```
sudo curl -fL https://github.com/kubeslice/kubeslice-cli/releases/download/0.5.2/kubeslice-cli-0.5.2-linux-amd64  -o /usr/local/bin/kubeslice-cli
```
...
[Kubeslice Configuration Parameters](/versioned_docs/version-0.7.0/reference/configuration-parameters.mdx). 
...
see [Uninstalling KubeSlice](/versioned_docs/version-0.7.0/kubeslice-cli/uninstalling-kubeslice.mdx).
