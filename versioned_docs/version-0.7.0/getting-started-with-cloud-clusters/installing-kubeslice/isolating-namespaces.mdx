...
same parameter to false in the slice configuration file. To know more, see [namespace isolation profile parameters](/versioned_docs/version-0.7.0/reference/configuration-parameters.mdx#namespace-isolation-profile-parameters)
and the [slice configuration YAML](/versioned_docs/version-0.7.0/getting-started-with-cloud-clusters/installing-kubeslice/creating-a-slice.mdx#create-the-slice-yaml-file) file.
