...
charts using the following command:
   ...
   opensource/kubeslice-controller    0.7.0            0.7.0         A Helm chart for kubeslice-controller             
   opensource/kubeslice-worker        0.7.0            0.21.0         A Helm chart for kubeslice-worker
   ```
