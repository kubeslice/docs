...
:::info
To understand more about the configuration parameters, see [Controller Configuration Parameters](/versioned_docs/version-0.7.0/reference/configuration-parameters.mdx#controller-configuration-parameters).
:::
...
Namespace Configuration Parameters](/versioned_docs/version-0.7.0/reference/configuration-parameters.mdx#project-namespace-configuration-parameters).
:::
