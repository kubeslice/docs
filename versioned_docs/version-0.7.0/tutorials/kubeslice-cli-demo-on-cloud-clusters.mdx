...
see [Prepare Clusters](/versioned_docs/version-0.7.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx).
...
[topology configuration](/versioned_docs/version-0.7.0/reference/sample-configuration-file.mdx#create-a-topology-configuration-file-for-cloud-clusters) file.
...
[Slice Configuration Parameters](/versioned_docs/version-0.7.0/reference/configuration-parameters.mdx#slice-configuration-parameters).
:::
...
To uninstall KubeSlice from your cloud clusters step-by-step, follow the instructions in [Uninstall KubeSlice](/versioned_docs/version-0.7.0/kubeslice-cli/uninstalling-kubeslice.mdx).