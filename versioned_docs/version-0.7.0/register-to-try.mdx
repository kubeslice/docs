...
* Run `kubeslice-cli install --profile=full-demo` to get a full environment setup for you. This setup 
  ...
  To know more, see [kubeslice-cli](/versioned_docs/version-0.7.0/kubeslice-cli/getting-started.mdx).
* If you want to practice installing Kubeslice, you can do the 
  [minimal-demo](/versioned_docs/version-0.7.0/tutorials/kubeslice-cli-demo.mdx).    
