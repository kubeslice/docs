...
```
:::info
To learn more about the configuration parameters used to create topology configuration file for KubeSlice, 
see [configuration parameters](/versioned_docs/version-0.7.0/reference/configuration-parameters.mdx).
:::