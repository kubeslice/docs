...
to be replicated is massive, its efficient to seperate the data into slices and process it seperately.
Slice boundaries are basically resources, with instructions that maintain the slices and also manages communication
of the pods and services across clusters, edges, clouds, data centers etc.

2. RFC1918 network addresses: The rapid growth of internet led to the exhaustion of the available ipV4 addresses, as a solution subnets 
