...
## Introduction
Bookinfo ([Bookinfo Application](https://istio.io/latest/docs/examples/bookinfo/)) is a sample application from Istio 
composed of four separate microservices productpage, details, reviews, and ratings. 
This topic describes the steps to install the Bookinfo application on a single cluster.
...
To view the deployed Bookinfo product page, we need the external IP of an application node and the exposed port
 we just retrieved. Use the following command to get your node details:
