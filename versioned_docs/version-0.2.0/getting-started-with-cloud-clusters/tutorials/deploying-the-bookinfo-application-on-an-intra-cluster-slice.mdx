...
## Introduction
Bookinfo (Bookinfo Application) is a sample application from Istio composed of four separate microservices productpage, details, reviews, and ratings. This topic describes the steps to install the Bookinfo application on a single cluster. 
...
* Install Istio in all worker clusters as described in Installing Istio.
