...
same parameter to false in the slice configuration file. To know more, see [namespace isolation profile parameters](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters.mdx#namespace-isolation-profile-parameters)
and the [slice configuration YAML](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/creating-a-slice.mdx#creating-the-slice-yaml-file) file.
...
In the above output, `peacock` is the slice name and `bookinfo` is the on-boarded 
