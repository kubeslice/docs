...
project. For more information, see [The KubeSlice Architecture](/versioned_docs/version-0.2.0/architecture.mdx).
...
Parameters](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters.mdx#project-namespace-configuration-parameters)
``` 
