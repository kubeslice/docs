...
Configuration Parameters](/blob/master/version_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters#controller-configuration-parameters)
