...
see [Adding the Helm Repository](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/prerequisites/preparing-the-cloud-clusters-for-registration.mdx#adding-the-helm-repository).
...
[Controller Configuration Parameters](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters.mdx#controller-configuration-parameters)
:::
...
For more information, see [The KubeSlice Architecture](/versioned_docs/version-0.2.0/architecture.mdx).
