...
Configuration Parameters](/kubelsice/docs/tree/master/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters#controller-configuration-parameters)
To install the KubeSlice Controller, create the `values.yaml` file using the following template.

[testing Parameters](/tree/master/versioned_docs_version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters#project-namespace-configuration-parameters)
...
Parameters](versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/configuration-parameters#project-namespace-configuration-parameters)
``` 
