...
After successfully registering the worker clusters with the KubeSlice Controller, create a slice to on-board your application namespaces. You can create a slice across the multiple clusters or intra-cluster.
...
see [Managing Namespaces](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx)
