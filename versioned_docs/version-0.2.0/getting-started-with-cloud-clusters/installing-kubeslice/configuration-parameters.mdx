...
| priority | Integer | QoS profiles allows traffic management within a slice as well as prioritization across slices. The value range is 0-3. 0 is the highest priority, and 3 is the lowest priority. | Mandatory |
