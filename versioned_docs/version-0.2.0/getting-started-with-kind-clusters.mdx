...
The `grep` and `awk` commands do not work on Windows. Use Git bash to use
...
a slice to on-board your application namespaces. You can create a slice across the 
...
on-boarded on a slice to form a micro network segment. To know more, see 
...
2. on-board the existing `iperf` namespace to the slice. To know more, see
   [on-boarding namespaces](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx).
 
   :::caution
   Ensure that you have on-boarded the iperf namespace. If you create a namespace after 
...
7. on-board the existing `iperf` namespace on the slice. To know more, see 
   [on-boarding namespaces](/versioned_docs/version-0.2.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx).

   :::caution
   Ensure that you have on-boarded the iperf namespace. If you create a
