...
[Script to Get the Secrets of the Worker Cluster](getting-started-with-cloud-clusters/installing-kubeslice/script-to-get-the-secrets-of-the-worker-cluster).
:::
...
[scripts](getting-started-with-cloud-clusters/installing-kubeslice/script-to-get-the-secrets-of-the-worker-cluster).
:::
...
[managing namespaces](/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces).

## Isolating Namespaces 
You can isolate namespaces in a slice by using the namespace isolation
feature. To know more, see [isolating namespaces](/getting-started-with-cloud-clusters/installing-kubeslice/isolating-namespaces).
...
2. Onboard the existing `iperf `namespace to the slice. To know more, see 
   [onboarding namespaces](getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces).
...
Refer to [Uninstalling KubeSlice](getting-started-with-cloud-clusters/uninstalling-kubeslice/).