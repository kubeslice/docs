...
Network Service Mesh (NSM) and Data Plane
The NSM component sets up the Kubeslice data plane and connects application pods to the slice overlay network. It consists of:
