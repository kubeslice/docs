...
## Charts
Try out the KubeSlice community version using the given helm charts.

 

## Supported Kubernetes Services 
This version of KubeSlice has been tested on Azure Kubernetes Service and Google Kubernetes Engine, and KIND Kubernetes clusters. The supported Kubernetes versions are 1.20, 1.21, and 1.22.
