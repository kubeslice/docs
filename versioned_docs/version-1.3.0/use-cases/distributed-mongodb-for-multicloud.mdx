...
To install the KubeSlice Controller and the worker:
...
3. Verify our multi cluster ready is for use! We can verify this by displaying the 'mongodb multi' object.
...
6. Now in master cluster again verify the multi cluster is ready is for use! We can verify this by displaying the 'mongodb multi' object as discussed in step 7c now as you can observe the state is running
