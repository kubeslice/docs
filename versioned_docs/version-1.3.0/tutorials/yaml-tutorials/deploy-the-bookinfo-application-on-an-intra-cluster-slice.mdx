...
see [Creating a Slice](/versioned_docs/version-1.3.0/install-kubeslice/yaml/slice-operations/slice-operations-slice-creation.mdx).
...
in [offboarding namespaces](/versioned_docs/version-1.3.0/uninstall-kubeslice.mdx#offboard-application-namespaces).
