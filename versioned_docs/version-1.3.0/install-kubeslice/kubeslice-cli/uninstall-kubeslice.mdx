...
[offboard Namespaces](/versioned_docs/version-1.3.0/uninstall-kubeslice.mdx#offboard-application-namespaces).
...
the Slice Operator, follow the instructions in the [uninstall the Slice Operator](/versioned_docs/version-1.3.0/uninstall-kubeslice.mdx#uninstall-the-slice-operator) 
section.
...
[uninstall the KubeSlice Controller](/versioned_docs/version-1.3.0/uninstall-kubeslice.mdx#uninstall-the-kubeslice-controller).
