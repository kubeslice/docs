...
![events](/images/version1.3.0/monitoring-events/kubernetes-events1.png)

3. Select **From an app manifest** to configure your app scopes and settings.
   
![events](/images/version1.3.0/monitoring-events/kubernetes-events2.png)

4. Select a workspace where you want to create an app and click **Next**.

![events](/images/version1.3.0/monitoring-events/kubernetes-events3.png)
...
![events](/images/version1.3.0/monitoring-events/kubernetes-events4.png)
...
2. Copy the **Bot User OAuth Token** and save the token for later use while deploying the 
 ...
 ![events](/images/version1.3.0/monitoring-events/bot-user-oauth-token.png)
...
![events](/images/version1.3.0/monitoring-events/app-level-token.png)

3. In the **Generate an app-level token** section, enter a token name. For example, `botkube` is a token name.

![events](/images/version1.3.0/monitoring-events/generate-app-level-token.png)
...
![events](/images/version1.3.0/monitoring-events/create-channel1.png)
...
![events](/images/version1.3.0/monitoring-events/add-bot-to-channel.png)
...
![events](/images/version1.3.0/monitoring-events/ksm-events.png)
...
The Slack channel displays the KubeSlice events for the controller cluster, as depicted in the following figure.
 ...
 ![events](/images/version1.3.0/monitoring-events/kubeslice-controller-events.png)

#### Worker Events
The Slack channel displays the KubeSlice events for the worker cluster, as depicted in the following figure.

![events](/images/version1.3.0/monitoring-events/kubeslice-worker-events.png)