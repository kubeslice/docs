...
:::info
For more information on the metrics description, see [KubeSlice Metrics](/versioned_docs/version-1.3.0/install-kubeslice/yaml/metrics/yaml-metrics-controller-metrics.mdx).
:::
