...
Installing KubeSlice in the Air-Gapped Environment

The latest kubeslice-cli version 0.6.0 now supports the installation of KubeSlice using local helm charts. 
For more information, see /versioned_docs/version-1.3.0/install-kubeslice/kubeslice-cli/install-kubeslice.mdx/#air-gapped-installation)
