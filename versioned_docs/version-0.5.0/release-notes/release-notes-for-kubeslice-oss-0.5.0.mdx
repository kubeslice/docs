...
- Occasional **spire-server** restarts are observed if it takes time to bring up a SPIRE server.
...
- Istio version 1.13 is incompatible with Kubernetes version 1.24. It might cause issues with KubeSlice version 0.5.0, which 
  ...
  In the following topics, you must skip the steps related to Istio:
