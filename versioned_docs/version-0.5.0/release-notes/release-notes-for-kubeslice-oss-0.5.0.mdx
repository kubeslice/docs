...
- If the spire server takes time to start up, the spire-server continues to restart, thus delaying the completion of cluster registration by a 2-3 minutes.
