...
charts using the following command:
   ...
   kubeslice/kubeslice-controller  0.5.1           0.6.3           A Helm chart for kubeslice-controller
   kubeslice/kubeslice-worker      0.5.0           0.15.1          A Helm Chart for kubeslice-worker
   ```
