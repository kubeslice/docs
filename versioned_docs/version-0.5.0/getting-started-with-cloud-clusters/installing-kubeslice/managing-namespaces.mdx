...
To know more on parameters, see [namespace isolation profile parameters](/versioned_docs/version-0.5.0/reference/configuration-parameters.mdx#namespace-isolation-profile-parameters).
...
from accessing them. To know more, see [offboard namespaces](/versioned_docs/version-0.5.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/offboarding-namespaces.mdx).
...
:::info
To understand more about the configuration parameters, see [Service Export Configuration Parameters](/versioned_docs/version-0.5.0/reference/configuration-parameters.mdx#service-export-configuration-parameters).
:::
```
