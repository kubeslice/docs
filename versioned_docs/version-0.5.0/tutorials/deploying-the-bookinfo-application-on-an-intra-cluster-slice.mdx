# Deploy the BookInfo Application on an Intra-cluster Slice
...
see [Installing KubeSlice](/versioned_docs/version-0.5.0/getting-started-with-cloud-clusters/installing-kubeslice/installing-the-kubeslice-controller.mdx) 
and [Registering the Worker Cluster](/versioned_docs/version-0.5.0/getting-started-with-cloud-clusters/installing-kubeslice/registering-the-worker-cluster.mdx).
...
see [Creating a Slice](/versioned_docs/version-0.5.0/getting-started-with-cloud-clusters/installing-kubeslice/creating-a-slice.mdx).
...
in [offboarding namespaces](/versioned_docs/version-0.5.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/offboarding-namespaces.mdx).
