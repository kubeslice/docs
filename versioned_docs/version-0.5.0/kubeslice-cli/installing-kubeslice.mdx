...
cluster with the KubeSlice Controller. For more information, see [demo using cloud clusters](/versioned_docs/version-0.5.0/tutorials/kubeslice-cli-demo-on-cloud-clusters.mdx).
...
[Slice Configuration Parameters](/versioned_docs/version-0.5.0/reference/configuration-parameters.mdx#slice-configuration-parameters).
:::
