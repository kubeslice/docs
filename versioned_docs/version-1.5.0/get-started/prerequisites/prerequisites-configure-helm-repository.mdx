...
charts using the following command:
   ...
   **Expected Output**
   ...
   kubeslice/kubeslice-controller  1.4.0           1.4.0           A Helm chart for kubeslice-controller
   kubeslice/kubeslice-worker      1.4.0           1.4.0           A Helm chart for kubeslice-worker
