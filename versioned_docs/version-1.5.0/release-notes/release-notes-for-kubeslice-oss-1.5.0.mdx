...
* Support for labeling/annotations of user-defined namespaces in KubeSlice Controller helm chart.
  For more information, see [Install the KubeSlice Controller](/versioned_docs/version-1.5.0/install-kubeslice/yaml/yaml-controller-install.mdx#create-kubeslice-controller-yaml).