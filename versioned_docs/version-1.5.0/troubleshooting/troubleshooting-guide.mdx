...
Check if the original subnet is still in the Released state and verify the timestamp. Ensure the SliceIpam resource was not deleted or manually modified.
