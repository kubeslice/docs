...
:::info
For more information on the metrics description, see [KubeSlice Metrics](/versioned_docs/version-1.15.0/install-kubeslice/yaml/metrics/yaml-metrics-controller-metrics.mdx).
:::
...
4. You should get the Slack API URL for Slack-based alerts. To create the Slack API URL on the `#kubeslice-events-alerts` channel, 
   ...
   ![alt](/images/version-1.5.0/monitor/slack-channel-admin-option.png)
...
6. Look for `incoming-webhook` in the **Search** field, and click `incoming-webhook` 
   ...
   ![alt](/images/version-1.5.0/monitor/slack-installed-apps.png)

7. Click **Add to Slack** to add incoming webhooks. 

   ![alt](/images/version-1.5.0/monitor/add-to-slack.png)

8. Under **Post to Channel**, choose **kubeslice-events-alerts** to post the alerts. 

   ![alt](/images/version-1.5.0/monitor/slack-post-to-channel.png)

9. Click **Add Incoming Webhooks integration**. 

   ![alt](/images/version-1.5.0/monitor/slack-add-incoming-webhook-integration.png)

10. You get a webhook URL that you should copy and note it down in a separate file for using it later. 

    ![alt](/images/version-1.5.0/monitor/slack-copy-webhook-url.png)

11. Click **Save Settings** to save the webhook integration. 

   ![alt](/images/version-1.5.0/monitor/slack-webhook-save.png)
