...
Custom chart values can be specified in the topology configuration, see [Topology Configuration Parameters](/versioned_docs/version-1.5.0/install-kubeslice/kubeslice-cli/topology-configuration.mdx).
