...
| sliceIpamType                                                        | String                                         | It is the type of the IP address management for the slice subnet. The default value is `Static`. Set the value to `Dynamic` if you want to enable Dynamic IPAM.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Mandatory |
...
spec:
  ...
  sliceGatewayProvider:
    ...
    sliceCaType: Local  
  sliceIpamType: Static # The default value is Static. Set the value to Dynamic if you want to enable Dynamic IPAM
