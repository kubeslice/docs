...
| Parameter                                              | Parameter Type | Description                                                            | Required  |
| ------------------------------------                   | -------------- | ---------------------------------------------------------------------- | --------- |
| [namespaceConfig](#namespace-configuration-parameters) | Object         | The labels and annotations associated with the namespace.              | Optional  |
...
| Parameter   | Parameter Type   | Description                | Required |
| ---------   | --------------   | -----------                | ---------|
| labels      | Dictionary       | The labels the KubeSlice Controller should have.      | Mandatory |  
| annotations | Dictionary       | The annotations the KubeSlice Controller should have. | Mandatory |
