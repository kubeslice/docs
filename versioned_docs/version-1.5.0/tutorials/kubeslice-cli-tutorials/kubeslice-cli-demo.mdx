...
:::info
To understand more about the configuration parameters, see [Slice Configuration Parameters](/versioned_docs/version-1.5.0/install-kubeslice/yaml/slice-operations/slice-operations-slice-creation.mdx).
:::
