...
see [Managing Namespaces](/versioned_docs/version-0.5.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx)
...
:::info
For example YAML files on kind clusters, see [kind YAML examples](/versioned_docs/version-0.5.0/tutorials/kind-create-slice.mdx).
:::
...
[Standard QoS Profile Parameters](/versioned_docs/version-0.5.0/reference/configuration-parameters.mdx#standard-qos-profile-parameters).
:::
