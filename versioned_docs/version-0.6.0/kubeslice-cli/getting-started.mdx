...
Example
```
sudo curl -fL https://github.com/kubeslice/kubeslice-cli/releases/download/0.4.3/kubeslice-cli-0.4.3-linux-amd64  -o /usr/local/bin/kubeslice-cli
```
...
This section describes KubeSlice commands,command syntax, options, a resource type, and a few examples of command usage.
