...
[Kubeslice Configuration Parameters](/versioned_docs/version-0.6.0/reference/configuration-parameters.mdx). 
...
see [Uninstalling KubeSlice](/versioned_docs/version-0.6.0/kubeslice-cli/uninstalling-kubeslice.mdx).
