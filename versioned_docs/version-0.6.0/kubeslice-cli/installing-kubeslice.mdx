...
Create a slice using the **kubeslice-cli** utility. For more information, see [demo using cloud clusters](/versioned_docs/version-0.6.0/tutorials/kubeslice-cli-demo-on-cloud-clusters.mdx).
