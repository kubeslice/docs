...
Install KubeSlice using the cluster descriptions that you provide in a custom topology YAML file. The KubeSlice Controller and worker 
...
After installing the KubeSlice Controller and registering workers with it, you can connect worker clusters. Create a slice 
to connect your worker clusters using the **kubeslice-cli** utility. For more information, see 
[demo using cloud clusters](/versioned_docs/version-0.6.0/tutorials/kubeslice-cli-demo-on-cloud-clusters.mdx).
