...
free to join our [community](/versioned_docs/version-0.6.0/community.mdx).
...
Configuration Parameters](/versioned_docs/version-0.6.0/reference/configuration-parameters.mdx#controller-configuration-parameters).
:::
...
[Script to Get the Secrets of the Worker Cluster](/versioned_docs/version-0.6.0/reference/script-to-get-the-secrets-of-the-worker-cluster.mdx).
:::
...
[scripts](/versioned_docs/version-0.6.0/reference/script-to-get-the-secrets-of-the-worker-cluster.mdx).
:::
...
:::info
To understand more about the configuration parameters, see [Slice
Configuration Parameters](/versioned_docs/version-0.6.0/reference/configuration-parameters.mdx#slice-configuration-parameters).
:::
...
[managing namespaces](/versioned_docs/version-0.6.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx).

## Isolating Namespaces 
You can isolate namespaces in a slice by using the namespace isolation
feature. To know more, see [isolating namespaces](/versioned_docs/version-0.6.0/getting-started-with-cloud-clusters/installing-kubeslice/isolating-namespaces.mdx).
...
2. Onboard the existing `iperf` namespace to the slice. To know more, see
   [onboarding namespaces](/versioned_docs/version-0.6.0/getting-started-with-cloud-clusters/installing-kubeslice/managing-namespaces.mdx).
...
Refer to [Uninstalling KubeSlice](/versioned_docs/version-0.6.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/offboarding-namespaces.mdx).
