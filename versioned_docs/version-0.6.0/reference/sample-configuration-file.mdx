...
This topic describes how to create a topology configuration file that is used to install KubeSlice. In your custom topology 
...
:::info
You can set `cluster_type: kind` in the custom topology file for kind clusters. This will install Calico (if not present already) and generate 
