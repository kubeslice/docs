...
This topic describes the parameters used in creating the custom topology file to install KubeSlice.
...
|[cert_manager_chart](#certificate-manager-chart-configuration-parameters)|Object|It is the **certificate manager** chart information.|Mandatory|
|[controller_chart](#controller-chart-configuration-parameters)|Object|It is the **controller** chart information.|Mandatory|
|[worker_chart](#worker-chart-configuration-parameters)|Object|It is the **worker** chart information.|Mandatory|
