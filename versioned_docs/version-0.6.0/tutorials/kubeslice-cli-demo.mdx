...
:::info
To understand more about the configuration parameters, see [Slice Configuration Parameters](/versioned_docs/version-0.6.0/reference/configuration-parameters.mdx#slice-configuration-parameters).
:::
