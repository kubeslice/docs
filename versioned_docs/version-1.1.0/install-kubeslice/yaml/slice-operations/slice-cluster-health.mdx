...
with a **Warning**. To know how to trace an issue in each component, see [slice and cluster health issues](../../../troubleshooting/troubleshooting-guide.mdx#/slice-and-cluster-health-issues).
