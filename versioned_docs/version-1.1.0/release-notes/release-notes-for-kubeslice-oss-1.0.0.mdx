...
For more information, see [the Worker Operator events](/versioned_docs/version-1.0.0/install-kubeslice/yaml/events/yaml-events-controller-events.mdx).
...
For more information, see [integrate KubeSlice-generated events on Slack](/versioned_docs/version-1.1.0/add-ons/add-ons-slack-events.mdx).
...
For more information, see [integrate alerts with Slack](/versioned_docs/version-1.1.0/add-ons/add-ons-slack-metrics.mdx).