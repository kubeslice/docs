...
[creating a standard QoS profile](/versioned_docs/version-1.1.0/versioned_docs/version-1.1.0/install-kubeslice/yaml/slice-operations/slice-operations-slice-creation.mdx#create-a-standard-qos-profile). 
