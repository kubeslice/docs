...
[offboarding Namespaces](/versioned_docs/0.4.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/offboarding-namespaces.mdx).
...
the Slice Operator, follow the instructions in the [uninstalling the Slice Operator](/versioned_docs/0.4.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/deregistering-the-worker-cluster.mdx#uninstalling-the-slice-operator) 
section.
...
[uninstalling the KubeSlice Controller](/versioned_docs/0.4.0/getting-started-with-cloud-clusters/uninstalling-kubeslice/uninstalling-the-kubeslice-controller).
