...
## Deleting the Project
   ...
   :::
   Deleting the project from the KubeSlice Controller deletes the service account, namespaces, clusters, secrets, certificates, and tokens.
...
## Uninstalling the KubeSlice Controller
   ...
   To uninstall the KuebSlice Controller, use the following command:
   ```
   kubeslice-cli uninstall --config=<topology-configuration-yaml>
   ```
