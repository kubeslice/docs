...
:::info
To understand more about the configuration parameters, see [Slice Configuration Parameters](/versioned_docs/version-0.4.0/getting-started-with-cloud-clusters/reference/configuration-parameters.mdx#slice-configuration-parameters).
:::
