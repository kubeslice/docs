...
service export using this command. The delete command can be used to unregister the registered worker cluster. 
Before unregistering the worker cluster you must offboard the namespaces and delete the slice. For more information, 
