...
|----|----|---|
| create | `kubeslice-cli create [flags]` | Creates one or more resources from a file. |
| delete | `kubeslice-cli delete [flags]` | Delete resources from a file.|
| describe | `kubeslice-cli describe [flags]` | Describe the KubeSlice resources.|
| edit | `kubeslice-cli edit [flags]` | Edit and update the definition of one or more kubeSlice resources.|
| get | `kubeslice-cli get [flags]` | List one or more kubeSlice resources.|
| install | `kubeslice-cli install [flags]` | Install kubeSlice resources.|
| uninstall | `kubeslice-cli uninstall [flags]` | Uninstall kubeSlice resources.|
