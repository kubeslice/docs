...
:::note
As the KubeSlice Controller is already installed, the following command skips both creating the new kind cluster 
and installing the KubeSlice Controller.
:::
```
...
:::note
As the KubeSlice Controller is already installed, the **--skip controller** or  **-s controller** option skips the installation of 
