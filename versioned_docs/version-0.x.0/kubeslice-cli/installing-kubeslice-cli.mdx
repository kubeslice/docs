...
To download the latest binary (~6 MB), use the following command:
```
sudo curl -fL https://github.com/kubeslice/kubeslice-cli/releases/download/0.3.0/kubeslice-cli-linux-amd64 -o /usr/local/bin/kubeslice-cli
```
