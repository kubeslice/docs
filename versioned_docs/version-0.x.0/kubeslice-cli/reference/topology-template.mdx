...
```
:::info
To understand more about the configuration parameters, see [configuration parameters](/versioned_docs/version-0.x.0/kubeslice-cli/reference/configuration-parameters.mdx)
:::