...
| [telemetry](#telemetry-parameters)     | Object         | It contains the telemetry configuration of the worker cluster.            | Optional |
...
| [imagePullSecrets](#slice-operator-image-pull-secrets) | Object         | This contains the secrets to access the repository that contains the image.                                          | Mandatory |
