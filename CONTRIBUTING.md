...
There are a number of ways you can contribute to the KubeSlice project. We would like to accept your patches and contributions to the KubeSlice code base. This document provides guidelines on how to contribute to the KubeSlice code base. We require all participants to adhere to the [Code of Conduct](https://github.com/kubeslice/docs/blob/master/code_of_conduct.md).
...
## Code of Conduct
Please make sure to read and observe our [Code of Conduct](https://github.com/kubeslice/docs/blob/master/code_of_conduct.md).
...
## Coding Guidelines
* Follow good [coding guidelines](https://docusaurus.io/docs/category/guides).
* Write good [commit messages](https://github.com/angular/angular/blob/main/CONTRIBUTING.md#-commit-message-format).

## Developer Guide
This guide helps you to get started with developing [kubeslice-controller](https://github.com/kubeslice/docs/blob/master/developer_guide.md).
